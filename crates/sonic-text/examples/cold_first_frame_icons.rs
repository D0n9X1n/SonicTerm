...
use sonic_text::glyph_atlas::GlyphAtlas;
use sonic_text::prewarm::prewarm_ascii_and_nerd;
use sonic_text::shape::{shape_run, RunStyle};
use sonic_text::swash_rasterizer::{load_bundled_fonts, SwashRasterizer};
...
fn main() {
    ...
    for row in &rows {
        ...
        for g in shaped {
            ...
            let key = sonic_types::GlyphKey::with_slot(g.ch, g.font_slot, false, false);
