...
//!
//! Mirrors the shape of `sonic_text::row_glyph_cache::RowGlyphCache`
...
/// Opaque per-pane identifier (mirrors `sonic_text::row_glyph_cache::PaneId`).
pub type PaneId = u64;
...
// Unit tests live in `crates/sonic-shared/tests/line_quad_cache_hit_miss.rs`.
