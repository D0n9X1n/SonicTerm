...
// PR 8b: keyboard / IME encoding helpers live in `super::input`. The
// previous monolithic `app.rs` carried these as private free fns at the
// bottom of the file; importing them here keeps every call site in
// `core.rs` compiling unchanged.
use super::input::{encode_key, key_event_to_string};
