//! Drag-chip overlay structs extracted from `render.rs`.
...
pub struct DragChipOverlay {
    ...
    /// Ghost alpha (default 0.5 per spec) — multiplier on the
