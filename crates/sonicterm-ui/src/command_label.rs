...
pub fn keywords(a: &Action) -> &'static [&'static str] {
    match a {
        ...
        Action::UpdateTabColor => &["tab", "color", "colour", "accent", "theme"],
        Action::NewWindow => &["create", "open"],
        Action::MoveTabToNewWindow => &["detach", "tear out", "pop out", "separate"],
        Action::ToggleFullscreen => &["maximize", "full"],
        Action::QuitApp => &["quit", "exit", "close app", "cmd+q", "terminate"],
