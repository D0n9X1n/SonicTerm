//! Integration tests for [`sonic_core::ssh`].
//!
...
use sonic_core::ssh::{parse_target, validate_host, validate_user, SshError, SshTarget};
...
fn handle_drop_signals_shutdown() {
    ...
    let res = sonic_core::ssh::SshHandle::connect(target, None, 80, 24);
