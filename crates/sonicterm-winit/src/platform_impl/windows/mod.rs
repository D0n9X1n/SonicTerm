// Modified by SonicTerm contributors to retain owned native metadata on Windows key events.
...
pub struct KeyEventExtra {
    ...
    pub native_key_event: Option<crate::platform::windows::NativeKeyEvent>,
}
