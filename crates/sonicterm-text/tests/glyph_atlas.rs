//! Tests for `sonicterm_text::glyph_atlas::GlyphAtlas`.

use sonicterm_text::glyph_atlas::{
...
fn atlas_full_returns_none_gracefully() {
    ...
    impl Rasterizer for Oversize {
        fn rasterize(&mut self, _: GlyphKey) -> Option<sonicterm_text::glyph_atlas::RasterTile> {
